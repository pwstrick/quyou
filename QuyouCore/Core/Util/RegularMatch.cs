...
namespace QuyouCore.Core.Util
{
    ...
    public class RegularMatch
    {
        ...
        #endregion 是否中国电话号码类型（XXX/XXXX-XXXXXXX/XXXXXXXX (/d{3,4})-?/d{7,8}）：判断是否是（区号：3或4位）-（电话号码：7或8位）#region 是否中国电话号码类型（XXX/XXXX-XXXXXXX/XXXXXXXX (/d{3,4})-?/d{7,8}）：判断是否是（区号：3或4位）-（电话号码：7或8位）
        /**//// <summary>
        ...
        /// <returns></returns>
        public bool CommRegularMatch(string strVerifyString, string strRegular, RegexOptions regOption, ref ArrayList aryResult, bool IsEntirety)
        {
            Regex r;
            Match m;
            #region 如果需要完全匹配的处理
        ...
        private string CheckCidInfo(string cid)
        {
            var aCity = new[]
            {
                ...
                null, null, null, "辽宁", "吉林", "黑龙江", null, null, null, null, null, null, null, "上海", "江苏", "浙江", "安微",
                "福建", "江西", "山东", null, null, null, "河南", "湖北", "湖南", "广东", "广西", "海南", null, null, null, "重庆", "四川",
                "贵州", "云南", "西藏", null, null, null, null, null, null, "陕西", "甘肃", "青海", "宁夏", "新疆", null, null, null,
                null, null, "台湾", null, null, null, null, null, null, null, null, null, "香港", "澳门", null, null, null,
